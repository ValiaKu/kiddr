    ...
    <div>
      ...
      <div className="Container Goal">
        <div className="Group">
          ...
          />
          <p>
            <strong>Programmer:</strong> Senior Front End Developer who focuses
            on writing clean, reusable, elegant and efficient code. Currently
            the main area of my interest is React and Svelte ecosystems.
          </p>
          <p>
          ...
          <div className="Skillset-wrapper">
            ...
            <div className="Skillset">
              ...
              <div className="Skillset-card">
                ...
                <ul>
                  <li>
                    TypeScript, JavaScript, React, Next.js, Svelte, Node.js,
                    Express, PixiJS, Angular, Gatsby, jQuery, three.js,
                    StoryBook, JS animations
                  </li>
                  <li>
                    CSS (grid, flexbox model, responsive), Material UI,
                    Tailwind, ShadCN, Radix, Preprocessors (SASS/SCSS, LESS),
                    HTML5/Canvas, BEM, Bootstrap, CSS and SVG animations
                  </li>
                  <li>
      ...
      <div className="Container Footer">
        <div className="Group">
          ...
          <ul>
            <li>
              <a
                href="https://www.ukma.edu.ua/eng/"
                target="_blank"
              >
